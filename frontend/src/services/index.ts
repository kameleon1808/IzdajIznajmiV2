...
export const getSimilarListings = pick('getSimilarListings')
export const getListingFacilities = pick('getListingFacilities')
export const getFacilitiesCatalog = pick('getFacilitiesCatalog')
...
export const pollMessages = pick('pollMessages')
...
export const getUsersPresence = pick('getUsersPresence')
export const getPublicProfile = pick('getPublicProfile')
export const updateMyProfile = pick('updateMyProfile')
export const uploadMyAvatar = pick('uploadMyAvatar')
export const changeMyPassword = pick('changeMyPassword')
export const deleteAccount = pick('deleteAccount')
export const requestEmailVerification = pick('requestEmailVerification')
export const confirmEmailVerification = pick('confirmEmailVerification')
...
export const replyToRating = pick('replyToRating')
export const getAdminRatings = pick('getAdminRatings')
export const getAdminUsers = pick('getAdminUsers')
...
export const getTransactions = pick('getTransactions')
...
export const markDepositPaidCash = pick('markDepositPaidCash')
export const completeTransaction = pick('completeTransaction')
export const confirmMoveIn = pick('confirmMoveIn')
export const reportTransaction = pick('reportTransaction')
export const getSharedTransactions = pick('getSharedTransactions')
...
export const updateAdminUserBadges = pick('updateAdminUserBadges')
export const getAdminLogs = pick('getAdminLogs')
