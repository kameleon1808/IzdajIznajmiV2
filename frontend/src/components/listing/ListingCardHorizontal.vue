...
<template>
  <div
    ...
    class="flex gap-3 rounded-[22px] bg-surface-2 p-3 shadow-card border border-border lg:gap-5 lg:p-5"
  ...
  >
    ...
    <div class="flex flex-1 flex-col gap-1 lg:gap-2">
      <div class="flex items-start justify-between">
        <div class="space-y-1">
          <h3 class="text-base font-semibold text-text leading-tight lg:text-lg">{{ listing.title }}</h3>
