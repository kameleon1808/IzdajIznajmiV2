...
class ListingController extends Controller
{
    ...
    public function index(Request $request, SearchFilterSnapshotService $snapshots, SavedSearchNormalizer $normalizer): JsonResponse
    {
        ...
        $filters = [
            ...
            'notLastFloor' => $request->boolean('notLastFloor') || $request->boolean('not_last_floor'),
            'notGroundFloor' => $request->boolean('notGroundFloor') || $request->boolean('not_ground_floor'),
